...
import { ArrowRight, FileText, Music, Truck, Flame, Archive, Package, Globe } from 'lucide-react'
      ...
      <div className="section-container">
        ...
        >
          ...
          <p className="section-subtitle">
            Pełen zakres profesjonalnych usług dla godnego pożegnania bliskiej osoby, w rodzinnej firmie z ponad 30-letnim doświadczeniem i uczciwymi cenami
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <ServiceCard
            ...
            description="Transport do Polski z Niemiec, UK, Irlandii, Holandii, Skandynawii i innych państw. Obsługa rodzin oraz partnerów branżowych z naciskiem na sprawną pomoc i konkurencyjne ceny."
            icon={<Globe className="w-8 h-8" />}
            link="/uslugi/sprowadzenie-zwlok-z-zagranicy"
            delay={400}
          />
