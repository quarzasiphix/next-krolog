...
export const metadata: Metadata = {
    title: 'Zakład Pogrzebowy Łowicz | Nekrolog Łódź',
    description: 'Profesjonalny zakład pogrzebowy w Łowiczu. Kompleksowe usługi pogrzebowe, kremacja, transport zmarłych. Dostępni 24/7. Tel: +48 602 274 661. Pogrzeb bez zaliczki.',
    keywords: ['zakład pogrzebowy łowicz', 'usługi pogrzebowe łowicz', 'pogrzeb łowicz', 'kremacja łowicz'],
    alternates: {
        canonical: `${SITE_URL}/zaklad-pogrzebowy-lowicz`,
    },
    openGraph: {
        title: 'Zakład Pogrzebowy Łowicz - Nekrolog Łódź',
        description: 'Kompleksowe usługi pogrzebowe w Łowiczu. Pogrzeb bez zaliczki. Dostępni całodobowo.',
        url: `${SITE_URL}/zaklad-pogrzebowy-lowicz`,
        type: 'website',
    },
}

const cityName = 'Łowicz'
const citySlug = 'lowicz'

export default function LowiczPage() {
    const faqData = [
        {
            question: `Czy Nekrolog Łódź organizuje pogrzeby w Łowiczu?`,
            answer: `Tak, organizujemy kompleksowe pogrzeby w Łowiczu i okolicach. Nasza siedziba znajduje się przy ul. Legionów 48 w Łodzi, ale obsługujemy cały region łódzki.`
        },
        {
        ...
        {
            question: `Jak szybko możecie dotrzeć do Łowicza?`,
            answer: `Jesteśmy dostępni całodobowo. Nasz zespół może dotrzeć do Łowicza w krótkim czasie od zgłoszenia.`
        },
        {
