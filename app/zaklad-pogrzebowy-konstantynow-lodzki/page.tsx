...
export const metadata: Metadata = {
    title: 'Zakład Pogrzebowy Konstantynów Łódzki | Nekrolog Łódź',
    description: 'Profesjonalny zakład pogrzebowy w Konstantynowie Łódzkim. Kompleksowe usługi pogrzebowe, kremacja, transport zmarłych. Dostępni 24/7. Tel: +48 602 274 661.',
    keywords: ['zakład pogrzebowy konstantynów łódzki', 'usługi pogrzebowe konstantynów', 'pogrzeb konstantynów łódzki'],
    alternates: {
        canonical: `${SITE_URL}/zaklad-pogrzebowy-konstantynow-lodzki`,
    },
    openGraph: {
        title: 'Zakład Pogrzebowy Konstantynów Łódzki - Nekrolog Łódź',
        description: 'Kompleksowe usługi pogrzebowe w Konstantynowie Łódzkim. Pogrzeb bez zaliczki.',
        url: `${SITE_URL}/zaklad-pogrzebowy-konstantynow-lodzki`,
        type: 'website',
    },
}

const cityName = 'Konstantynów Łódzki'
const citySlug = 'konstantynow-lodzki'

export default function KonstantynowPage() {
    const faqData = [
        {
            question: `Czy Nekrolog Łódź organizuje pogrzeby w Konstantynowie Łódzkim?`,
            answer: `Tak, organizujemy kompleksowe pogrzeby w Konstantynowie Łódzkim i okolicach. Nasza siedziba znajduje się przy ul. Legionów 48 w Łodzi.`
        },
        {
        ...
        {
            question: `Jak szybko możecie dotrzeć do Konstantynowa Łódzkiego?`,
            answer: `Jesteśmy dostępni całodobowo i możemy dotrzeć do Konstantynowa Łódzkiego w ciągu godziny od zgłoszenia.`
        },
        {
