...
export const metadata: Metadata = {
    title: 'Zakład Pogrzebowy Aleksandrów Łódzki | Nekrolog Łódź',
    description: 'Profesjonalny zakład pogrzebowy w Aleksandrowie Łódzkim. Kompleksowe usługi pogrzebowe, kremacja, transport zmarłych. Dostępni 24/7. Tel: +48 602 274 661.',
    keywords: ['zakład pogrzebowy aleksandrów łódzki', 'usługi pogrzebowe aleksandrów', 'pogrzeb aleksandrów łódzki'],
    alternates: {
        canonical: `${SITE_URL}/zaklad-pogrzebowy-aleksandrow-lodzki`,
    },
    openGraph: {
        title: 'Zakład Pogrzebowy Aleksandrów Łódzki - Nekrolog Łódź',
        description: 'Kompleksowe usługi pogrzebowe w Aleksandrowie Łódzkim. Pogrzeb bez zaliczki.',
        url: `${SITE_URL}/zaklad-pogrzebowy-aleksandrow-lodzki`,
        type: 'website',
    },
}

const cityName = 'Aleksandrów Łódzki'
const citySlug = 'aleksandrow-lodzki'

export default function AleksandrowPage() {
    const faqData = [
        {
            question: `Czy Nekrolog Łódź organizuje pogrzeby w Aleksandrowie Łódzkim?`,
            answer: `Tak, organizujemy kompleksowe pogrzeby w Aleksandrowie Łódzkim i okolicach. Nasza siedziba znajduje się przy ul. Legionów 48 w Łodzi, ale obsługujemy cały region.`
        },
        {
        ...
        {
            question: `Jak szybko możecie dotrzeć do Aleksandrowa Łódzkiego?`,
            answer: `Jesteśmy dostępni całodobowo i możemy dotrzeć do Aleksandrowa Łódzkiego w ciągu godziny od zgłoszenia.`
        },
        {
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <p className="text-gray-300 mb-4 leading-relaxed">
                                ...
                                dla mieszkańców {cityName} i okolic. Zapewniamy pełne wsparcie w organizacji ceremonii pogrzebowej.
                            </p>
                        </div>
                    </div>
                </div>
