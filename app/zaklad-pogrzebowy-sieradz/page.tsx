...
export const metadata: Metadata = {
    title: 'Zakład Pogrzebowy Sieradz | Nekrolog Łódź',
    description: 'Profesjonalny zakład pogrzebowy w Sieradzu. Kompleksowe usługi pogrzebowe, kremacja, transport zmarłych. Dostępni 24/7. Tel: +48 602 274 661. Pogrzeb bez zaliczki.',
    keywords: ['zakład pogrzebowy sieradz', 'usługi pogrzebowe sieradz', 'pogrzeb sieradz', 'kremacja sieradz'],
    alternates: {
        canonical: `${SITE_URL}/zaklad-pogrzebowy-sieradz`,
    },
    openGraph: {
        title: 'Zakład Pogrzebowy Sieradz - Nekrolog Łódź',
        description: 'Kompleksowe usługi pogrzebowe w Sieradzu. Pogrzeb bez zaliczki. Dostępni całodobowo.',
        url: `${SITE_URL}/zaklad-pogrzebowy-sieradz`,
        type: 'website',
    },
}

const cityName = 'Sieradz'
const citySlug = 'sieradz'

export default function SieradzPage() {
    const faqData = [
        {
            question: `Czy Nekrolog Łódź organizuje pogrzeby w Sieradzu?`,
            answer: `Tak, organizujemy kompleksowe pogrzeby w Sieradzu i okolicach. Nasza siedziba znajduje się przy ul. Legionów 48 w Łodzi.`
        },
        {
        ...
        {
            question: `Jak szybko możecie dotrzeć do Sieradza?`,
            answer: `Jesteśmy dostępni całodobowo. Zapewniamy szybki dojazd do Sieradza w razie potrzeby.`
        },
        {
