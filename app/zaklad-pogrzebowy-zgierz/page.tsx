...
export const metadata: Metadata = {
    title: 'Zakład Pogrzebowy Zgierz | Nekrolog Łódź',
    description: 'Profesjonalny zakład pogrzebowy w Zgierzu. Kompleksowe usługi pogrzebowe, kremacja, transport zmarłych. Dostępni 24/7. Tel: +48 602 274 661. Pogrzeb bez zaliczki.',
    keywords: ['zakład pogrzebowy zgierz', 'usługi pogrzebowe zgierz', 'pogrzeb zgierz', 'kremacja zgierz', 'transport zmarłych zgierz'],
    alternates: {
        canonical: `${SITE_URL}/zaklad-pogrzebowy-zgierz`,
    },
    openGraph: {
        title: 'Zakład Pogrzebowy Zgierz - Nekrolog Łódź',
        description: 'Kompleksowe usługi pogrzebowe w Zgierzu. Pogrzeb bez zaliczki. Dostępni całodobowo.',
        url: `${SITE_URL}/zaklad-pogrzebowy-zgierz`,
        type: 'website',
    },
}

const cityName = 'Zgierz'
const citySlug = 'zgierz'

export default function ZgierzPage() {
    const faqData = [
        {
            question: `Czy Nekrolog Łódź organizuje pogrzeby w Zgierzu?`,
            answer: `Tak, organizujemy kompleksowe pogrzeby w Zgierzu i okolicach. Oferujemy pełen zakres usług pogrzebowych, transport zmarłych oraz załatwiamy wszystkie formalności. Nasza siedziba znajduje się przy ul. Legionów 48 w Łodzi.`
        },
        {
        ...
        {
            question: `Jak szybko możecie dotrzeć do Zgierza?`,
            answer: `Jesteśmy dostępni całodobowo i możemy dotrzeć do Zgierza w ciągu godziny od zgłoszenia. Nasz zespół jest zawsze gotowy do natychmiastowej pomocy.`
        },
        {
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="bg-primary/10 border border-primary/30 rounded-lg p-8 mb-12">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-white mb-2">Bliska Lokalizacja</h4>
                                        <p className="text-gray-300">Siedziba w Łodzi - szybki dojazd do {cityName}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <p className="text-gray-300 mb-4 leading-relaxed">
                                {BUSINESS_INFO.name} to renomowany zakład pogrzebowy z siedzibą przy ul. Legionów 48 w Łodzi,
                                który od wielu lat świadczy kompleksowe usługi pogrzebowe dla mieszkańców {cityName} i okolic.
                                Specjalizujemy się w organizacji ceremonii pogrzebowych dostosowanych do indywidualnych potrzeb każdej rodziny.
                            </p>
                            <p className="text-gray-300 mb-4 leading-relaxed">
                                Obsługujemy całe miasto {cityName} oraz okoliczne miejscowości. Nasz doświadczony zespół zna lokalne
                                cmentarze i kościoły, co pozwala nam sprawnie organizować ceremonię zgodnie z Państwa życzeniami.
                            </p>
                        </div>
                    </div>
                </div>
